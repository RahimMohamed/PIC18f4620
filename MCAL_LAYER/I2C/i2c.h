 ...
 *
 * Created on July 9, 2024, 2:34 PM
 */
...
typedef struct{
	uint_8 i2c_mode_cfg;             /* Master Synchronous Serial Port Mode Select */
    uint_8 i2c_slave_address;        /* I2C Slave Address */
	uint_8 i2c_mode : 1;				/* I2C : Master or Slave Mode */
	uint_8 i2c_slew_rate : 1; 		/* Slew Rate Enable/Disable */
	uint_8 i2c_SMBus_control : 1; 	/* SMBus Enable/Disable */
	uint_8 i2c_general_call : 1;		/* General Call Enable/Disable */
	uint_8 i2c_master_rec_mode : 1; 	/* Master Receive Mode Enable/Disable */
	uint_8 i2c_reserved : 3;  
    #if INTERRUPT_PRIORITY_LEVELS_ENABLE==INERRUPT_FEAUTURE_ENABLE
    priority_t mssp_i2c_priority;
    priority_t mssp_i2c_bc_priority;
#endif   
...
typedef struct{
	uint_32 i2c_clock;	/* Master Clock Frequency */
...
Std_ReturnType MSSP_I2C_Master_Write_Blocking(const mssp_i2c_t *i2c_obj, uint_8 i2c_data, uint_8 *_ack);
