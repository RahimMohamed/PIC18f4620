...
/* Interrupt Priority Configurations */
        ...
        if(HIGH_priority == i2c_obj->i2c_cfg.mssp_i2c_priority){
            /* Enables all high-priority interrupts */
            INTERRUPT_GlobalHighPriority_Enable();
            MSSP_I2C_HighPrioritySet();
        }
        else if(LOW_priority== i2c_obj->i2c_cfg.mssp_i2c_priority){
        ...
        if(HIGH_priority== i2c_obj->i2c_cfg.mssp_i2c_bc_priority){
            /* Enables all high-priority interrupts */
            INTERRUPT_GlobalHighPriority_Enable();
            MSSP_I2C_BUS_COL_HighPrioritySet();
        }
        else if(LOW_priority == i2c_obj->i2c_cfg.mssp_i2c_bc_priority){
            /* Enables all unmasked peripheral interrupts */
            INTERRUPT_GlobalLowPriority_Enable();
